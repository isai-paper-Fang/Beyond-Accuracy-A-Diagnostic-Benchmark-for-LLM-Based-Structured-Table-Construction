...
MODELS = ["ChatGPT", "Claude", "Gemini", "Typhoon"]
TASKS = ["T1", "T3", "T4", "T5", "T6", "T7"]
REPS = [1, 2, 3]

# งานนำร่อง 8 รัน ตาม HANDOFF: 2 โมเดล × 4 งาน (rep 1)
PILOT = [(m, t, 1) for m in ["Claude", "Typhoon"] for t in ["T1", "T3", "T6", "T7"]]
